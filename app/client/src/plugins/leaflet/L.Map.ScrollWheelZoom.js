...
L.Map.SmoothWheelZoom = L.Handler.extend({
  ...
  _updateWheelZoom: function () {
    ...
    if (map.getMaxZoom() == this._goalZoom) this._zoom = map.getMaxZoom();
    //if(map.getMinZoom() == this._goalZoom) this._zoom = map.getMinZoom();

    if (!this._zoom && this._prevZoom == this._zoom) {
      map.fire("mapchange");
      return;
    }
